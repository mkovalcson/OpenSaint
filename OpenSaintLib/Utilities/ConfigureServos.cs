...
{
    /// <summary>
    /// This defines all 24 of the servos that my desk top J5 uses from the Neck tilt up
    /// It then sets them to their Home value and disables them.
    ///    
    /// </summary>
    public static class ServoConfig
    {
     /// <summary>
     /// Hard coded ranges for all Servos
     /// 
     /// </summary>
     /// <param name="headPort"></param>
     /// <returns></returns>
        public static Servo[] ConfigureServos(string headPort) // ,string torsoPort )
        {
